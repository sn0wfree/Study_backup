...
#count_of_Grand.Total
boxplot(crowdfunding$count_of_Grand.Total[crowdfunding$Region=="Midwest"],crowdfunding$count_of_Grand.Total[crowdfunding$Region=="Northeast"],crowdfunding$count_of_Grand.Total[crowdfunding$Region=="South"],crowdfunding$count_of_Grand.Total[crowdfunding$Region=="West"],names=levels(crowdfunding$Region),main="Count of Projects BoxPlot by Region",varwidth=TRUE)
...
#successful_rate
boxplot(crowdfunding$successful_rate[crowdfunding$Region=="Midwest"],crowdfunding$successful_rate[crowdfunding$Region=="Northeast"],crowdfunding$successful_rate[crowdfunding$Region=="South"],crowdfunding$successful_rate[crowdfunding$Region=="West"],names=levels(crowdfunding$Region),main="Successful Rate BoxPlot by Region")
...
qqline(crowdfunding$count_of_Grand.Total[crowdfunding$Region=="West"])
 ...
 kurtosis(crowdfunding$count_of_Grand.Total[crowdfunding$Region=="Midwest"])
 kurtosis(crowdfunding$count_of_Grand.Total[crowdfunding$Region=="Northeast"])      
 kurtosis(crowdfunding$count_of_Grand.Total[crowdfunding$Region=="South"])      
 kurtosis(crowdfunding$count_of_Grand.Total[crowdfunding$Region=="West"]) 
...
require(lmtest)
require(strucchange)
resettest(log(crowdfunding$successful_rate)~log(crowdfunding$GiniCoeff))
