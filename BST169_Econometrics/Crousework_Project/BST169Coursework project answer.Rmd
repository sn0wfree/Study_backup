...
$y_{i}=\beta_{0}+\beta_{1}x_{1}+\beta_{2}x_{2}+\epsilon_{i}$ with $\beta_{1}+\beta_{2}=1$
=> $y_{i}=\beta_{0}+\beta_{1}x_{1}+(1-\beta_{1})x_{2}+\epsilon_{i}$
$y_{i}-x_{2}=\beta_{0}+\beta_{1}(x_{1}-x_{2})+\epsilon_{i}$
in lecture 3
...
bootstrap lecture:h-test or white test
